...
export const listProducts = () => async (dispatch) => {
    try {
        ...
        dispatch({
            ...
            payload: error.response && error.response.data.message ? error.response.data.message : error.message//this'll give us our custom message from the error handler we made or a generic error message
        })
    }
