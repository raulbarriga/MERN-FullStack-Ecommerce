...
userSchema.pre("save", async function (next) {
  ...
  if (!this.isModified("password")) {
    //this covers the case when we update our profile's name, etc. but not the password; if the profile's updated, we don't want to hash the password again, otherwise we won't be able to login.
